...
const typeList = ['Polo Tshirts','Dress shirts','Shorts','T-Shirts','Shoes','Watches']
...
<View style={style.filterContainer}>
    ...
    <View style={style.filters}>
         <TouchableOpacity style={style.filter} onPress={()=>alert("Pressed Sort")}>
         <Image source={require("../assets/icons/sort.png")}/><Text style={style.filterText}>SORT</Text>
         </TouchableOpacity>
         <View style={style.middleFilter}/>
         <TouchableOpacity  style={style.filter} onPress={()=>alert("Pressed Filter")}>
     <Image source={require("../assets/icons/filter.png")}/><Text style={style.filterText}>FILTER</Text>
         </TouchableOpacity>
     </View>
</View>
...
<ScrollView horizontal={true}>
    ...
    {typeList.map((content,id)=><TouchableOpacity onPress={()=>alert(`Pressed ${content}`)} key={id} style={style.itemList}><Text style={style.item}>{content}</Text></TouchableOpacity>)}
    </View>
</ScrollView>
</View>
...
<ScrollView>
    ...
    <TouchableOpacity onPress={()=>alert(`Pressed on ${brand} having id ${id} price ${price}`)} key={id} style={style.viewList}>
    ...
    <TouchableOpacity onPress={()=>alert(`Pressed wishlist icon for brand ${brand} !`)} style={style.wishlist}>
